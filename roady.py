# hotaraste daca e benzina sau motorina
# oras plecare sosire
# nr persoane
# consum
import json
...
class Roady:
    ...
    def __init__(self, departure_city: str, destination_city: str,
                 number_of_persons: int, fuel_usage: float, fuel: str  = "benzina", path: str = "config.json"):
    ...
    def calculate_price_per_person(self):
        ...
        total_liter =km * self.fuel_usage / 100
        total_price = total_liter * self.gas.avg_price
